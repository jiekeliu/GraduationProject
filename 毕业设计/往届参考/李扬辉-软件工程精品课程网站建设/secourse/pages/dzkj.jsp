...
<%@page import="aaa.Utility"%><!--指定jsp源文件的编码格式-->
<%
					...
					<table width="181" height="241" border="1" cellpadding="0"
						...
						<tr>
							<td height="201" align="center" valign="top">
								...
								<p>
									<a href="dzkj.jsp" target="_parent">
								...
								<p>
									<a href="zuoye.jsp" target="_parent">作业下载</a>
								</p>
							</td>
						</tr>
					</table>
