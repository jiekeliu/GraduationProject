...
if ($Rimg_url == '') {
	ob_clean();
	exit(json_encode(array('code'=>0,'msg'=>'后台提示：文章缺少附加图')));
}

if ($Rinfo == '') {
	ob_clean();
	exit(json_encode(array('code'=>0,'msg'=>'后台提示：文章缺少简介')));
}
...
$sql = new Sqlcontra;
$sql_res =$sql->results_insert($Rtitile, $Rinfo, $Rimg_url, $Rtext, $Rauthor, $Rtype, $Rtime);
